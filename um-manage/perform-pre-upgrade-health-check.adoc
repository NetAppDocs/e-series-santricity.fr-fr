...
. Une fois la vérification de l'état terminée, vous pouvez cliquer sur les points de suspension (...) à droite de chaque ligne pour afficher plus d'informations et effectuer d'autres tâches.
+
[NOTE]
====
