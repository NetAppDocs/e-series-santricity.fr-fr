...
[NOTE]
====
La mise en miroir synchrone n'est pas disponible sur la baie de stockage EF80, EF50, EF600/EF600C ou EF300/EF300C.
...
NOTE: Les contrôleurs E4000 ne prennent pas en charge la mise en miroir iSCSI.
...
* Le partitionnement des ressources ne doit pas être activé pour les volumes primaires et secondaires.
