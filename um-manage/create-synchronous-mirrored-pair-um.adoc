...
[NOTE]
====
Cette fonctionnalité n'est pas disponible sur le système de stockage EF80, EF50, EF600/EF600C ou EF300/EF300C.
...
Accédez à System Manager et au menu : Storage [Operations in Progress] pour consulter la progression de l’opération de mise en miroir synchrone. Cette opération peut être longue et pourrait affecter les performances du système.
