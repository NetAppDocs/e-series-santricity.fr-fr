...
. Sélectionnez l'objet de stockage pour lequel vous souhaitez augmenter la capacité réservée, puis cliquez sur le menu : ellipsis icon[Increase reserved capacity].
+
La page « Increase Reserved Capacity » s'affiche.
