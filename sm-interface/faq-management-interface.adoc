...
Le graphique de latence fournit des statistiques de latence, en millisecondes (ms), pour les volumes, les groupes de volumes, les pools, les applications et les charges de travail. Ce graphique apparaît dans les onglets Vue logique, Vue physique et Vue Applications et charges de travail.
...
Le graphique IOPS affiche les statistiques des opérations d'entrée/sortie par seconde. Sur la page d'accueil, ce graphique affiche les statistiques de la baie de stockage. Dans les onglets Vue logique, Vue physique et Vue Applications et charges de travail de la page Performances, ce graphique affiche les statistiques de la baie de stockage, des volumes, des groupes de volumes, des pools, des applications et des charges de travail.
...
Le graphique Mio/s affiche les statistiques de vitesse de transfert en mébioctets par seconde. Sur la page d'accueil, ce graphique affiche les statistiques de la baie de stockage. Dans les onglets Vue logique, Vue physique et Vue Applications et charges de travail de la page Performances, ce graphique affiche les statistiques de la baie de stockage, des volumes, des groupes de volumes, des pools, des applications et des charges de travail.
...
Le graphique CPU affiche les statistiques de capacité de traitement de chaque contrôleur (contrôleur A et contrôleur B). CPU est l’abréviation de _central processing unit_. Sur la page d’accueil, ce graphique affiche les statistiques de la baie de stockage. Dans l’onglet Vue physique de la page Performances, ce graphique affiche les statistiques de la baie de stockage et des disques.
...
Le graphique de marge de manœuvre est lié à la capacité de performance restante des contrôleurs de la baie de stockage. Ce graphique est visible sur la page d'accueil et dans l'onglet Vue physique de la page Performances.
