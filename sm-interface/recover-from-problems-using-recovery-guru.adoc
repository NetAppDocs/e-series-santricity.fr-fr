...
.Étapes
. Dans le panneau de gauche, sélectionnez *Home*.
. Cliquez sur l'icône *Cloche* puis sur le lien intitulé *Récupérer de _n_ problèmes* au centre en haut de la fenêtre.
+
...
+
Le fichier est enregistré dans le dossier Téléchargements de votre navigateur sous le nom `recoveryGuru-failureName-arrayName-yyyy-mm-dd-hh-mm-ss.html`.
