...
Vous pouvez configurer les alertes depuis l'assistant de configuration initiale (pour les alertes par e-mail uniquement) ou depuis la page Alerts. Pour accéder à la page Alerts, allez dans menu:Settings[Alerts] depuis le panneau de gauche.
