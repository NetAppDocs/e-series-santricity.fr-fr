...
** *Sélectionnez le fichier de clé privée* -- Si nécessaire, cliquez sur le deuxième bouton *Parcourir* pour sélectionner un fichier de clé privée pour les contrôleurs de la storage array.
