...
.Étapes
. Dans le System Manager, repérez et notez le numéro de série du châssis. Dans le panneau de gauche, accédez au menu : Support[Support Center] et faites défiler vers le bas jusqu’à *View top storage array properties* pour afficher le numéro de série du châssis.
. Dans System Manager, repérez le Feature Enable Identifier. Dans le panneau de gauche, accédez au menu : Settings[System], puis faites défiler jusqu'à *Add-ons*. Recherchez le *Feature Enable Identifier*. Notez le numéro du Feature Enable Identifier.
