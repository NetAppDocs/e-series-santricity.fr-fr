...
NOTE: Les baies de stockage EF80, EF50, EF600/EF600C et EF300/EF300C ne prennent pas en charge la mise en miroir synchrone ni les volumes fins.
...
Unified Manager est un logiciel web permettant de gérer l'ensemble de votre domaine. Depuis une vue centrale, vous pouvez consulter l'état de toutes les baies E-Series et EF-Series récentes, telles que les EF80, EF50, E4000, E2800, EF280, EF300, E5700, EF570, EF600, EF300C et EF600C. Vous pouvez également effectuer des opérations par lots sur les baies de stockage sélectionnées.
