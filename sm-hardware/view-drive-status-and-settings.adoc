...
Compatible DULBE
 a| 
Indique si l’option pour Deallocated or Unwritten Logical Block Error (DULBE) est activée (Oui) ou non (Non). DULBE est une option sur les disques NVMe qui permet à la baie de stockage EF80, EF50, EF300 ou EF600 de prendre en charge les volumes à provisionnement de ressources.
