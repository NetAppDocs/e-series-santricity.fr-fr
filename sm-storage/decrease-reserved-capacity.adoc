...
. Sélectionnez l'objet de stockage pour lequel vous souhaitez diminuer la capacité réservée, puis cliquez sur l'icône menu:ellipsis icon[Decrease Capacity].
+
La page « Diminuer la capacité réservée » s'affiche.
