...
. Cliquez sur l’icône de menu : ellipsis [Initialize volumes].
+
...
Sélectionnez le menu : Storage[Operations in Progress] pour afficher la progression de l’opération d’initialisation en cours sur le volume sélectionné. Cette opération peut être longue et pourrait affecter les performances du système.
