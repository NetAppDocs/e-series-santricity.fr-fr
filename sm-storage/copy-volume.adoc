...
. Sélectionnez le volume que vous souhaitez utiliser comme source pour l'opération Copy Volume, puis cliquez sur l'icône menu:ellipsis icon[Copy volume].
+
La fenêtre Copier le volume apparaît.
...
Sélectionnez le menu : Storage[Operations in Progress] pour afficher la progression de l’opération Copy Volume. Cette opération peut être longue et pourrait affecter les performances du système.
