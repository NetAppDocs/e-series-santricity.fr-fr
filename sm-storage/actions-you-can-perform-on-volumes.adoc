...
+
Vous ajoutez de la capacité à un volume en sélectionnant menu:Storage[Volumes] dans le panneau de gauche, puis en sélectionnant le menu:ellipsis icon[Increase capacity] pour le volume.
...
+
Vous ajoutez de la capacité non attribuée au pool ou au groupe de volumes en sélectionnant menu :Storage[Pools and Volume Groups > Add capacity].
...
Lorsque vous copiez des volumes, vous créez une copie à un instant précis de deux volumes distincts, le volume source et le volume cible, sur la même baie de stockage. Vous pouvez copier des volumes en sélectionnant menu:Storage[Volumes] puis en sélectionnant menu:ellipsis icon[Copy volume].
...
Vous pouvez initialiser les volumes en sélectionnant le menu : Storage [Volumes > ellipsis icon > Initialize volumes].
...
Vous pouvez redistribuer les volumes en sélectionnant le menu : Storage [Volumes > ellipsis icon > Redistribute volumes].



== Changer la propriété du volume

Modifier le propriétaire d'un volume modifie la propriété du contrôleur préféré de ce volume. Le propriétaire du contrôleur préféré d'un volume est indiqué dans le menu : Storage [Volumes > ellipsis icon > Edit settings].

Vous pouvez modifier le propriétaire d'un volume en sélectionnant menu:Storage[Volumes > icône ellipse > Modifier le propriétaire du volume].
...
Sélectionnez le menu : Storage [Volumes > ellipsis icon > Change cache settings] pour modifier les paramètres de cache suivants :
