...
DA est activé si tous les disques sont compatibles DA. DA peut être désactivé après la création du volume en sélectionnant menu : Storage [Volumes > ellipsis icon > Disable Data Assurance].



 a| 
Resource Provisioning Capable (EF80, EF50, EF300 et EF600 uniquement)
 a| 
Indique si Resource Provisioning est disponible pour ce pool candidate. Resource Provisioning est une fonctionnalité disponible dans les baies de stockage EF80, EF50, EF300 et EF600, qui permet aux volumes d'être mis en service immédiatement sans processus d'initialisation en arrière-plan.
