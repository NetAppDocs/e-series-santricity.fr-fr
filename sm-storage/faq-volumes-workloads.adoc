...
* Vous pouvez également accéder au menu : Storage [Pools and volume groups] depuis le panneau de gauche, puis sélectionner l’icône menu : ellipsis icon [Consolidate volume group free capacity] pour ouvrir la boîte de dialogue.
