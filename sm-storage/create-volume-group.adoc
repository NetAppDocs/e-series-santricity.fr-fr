...
Resource Provisioning Capable (EF80, EF50, EF300 et EF600 uniquement)
 a| 
Indique si l'allocation de ressources est disponible pour ce groupe. L'allocation de ressources est une fonctionnalité disponible sur les baies de stockage EF80, EF50, EF300 et EF600, qui permet une mise en service immédiate des volumes, sans processus d'initialisation en arrière-plan.
