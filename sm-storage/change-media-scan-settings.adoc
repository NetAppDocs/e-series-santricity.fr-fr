...
. Cliquez sur l’icône de menu: ellipsis [Change volume media scan settings].
+
La fenêtre « Modifier les paramètres d'analyse du support de stockage » s'affiche. Tous les volumes de la baie de stockage apparaissent dans cette boîte de dialogue.

. Pour activer l'analyse du support, cochez la case à cocher *Media scan*.
+
