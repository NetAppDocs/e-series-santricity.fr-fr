...
* Lorsqu'une capacité non attribuée est détectée, la recommandation de configuration automatique du pool s'affiche dans la zone de notifications (icône de cloche en haut de la fenêtre). Cliquez sur *Afficher la configuration automatique du pool* pour ouvrir la boîte de dialogue.
...
. Cliquez sur l'icône de menu: ellipsis [Launch pool auto-configuration].
+
...
. Pour afficher les caractéristiques supplémentaires du pool, cliquez sur le nom du pool affiché.
+
