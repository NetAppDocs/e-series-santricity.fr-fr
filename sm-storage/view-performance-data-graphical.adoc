...
* *Vue Applications et charges de travail* -- Affiche une liste d'objets logiques (volumes) regroupés par types d'applications et charges de travail que vous avez définis.
...
. Sélectionnez l'onglet *Logical View*, l'onglet *Physical View* ou l'onglet *Applications and workloads View*.
+
...
** *Disques* : latence, IOPS, MIB/s
 ...
 a| 
Applications et charges de travail Affichage
 a| 
** *Storage array*: IOPS, MIB/s
