...
. Sélectionnez le volume membre du groupe de cohérence que vous souhaitez modifier, puis cliquez sur l’icône de menu : ellipse [Modifier les paramètres].
+
La fenêtre « Modifier le volume des membres du groupe de cohérence » s'affiche.
...
Seuil d'alerte de capacité réservée atteinte
 a| 
Utilisez la barre pour ajuster le point de pourcentage auquel System Manager envoie une notification d'alerte lorsque la capacité réservée pour un volume membre est presque pleine.
