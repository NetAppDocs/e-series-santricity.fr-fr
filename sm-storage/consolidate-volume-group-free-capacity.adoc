...
* Vous pouvez également lancer la boîte de dialogue Consolider la capacité libre à partir de la page Pools et volume groups, comme décrit dans la tâche suivante.
...
. Cliquez sur l’icône de menu : ellipsis [Consolidate volume group free capacity].
+
...
Sélectionnez le menu : Storage[Operations in Progress] pour consulter la progression de l’opération Consolidate Free Capacity. Cette opération peut être longue et pourrait affecter les performances du système.
