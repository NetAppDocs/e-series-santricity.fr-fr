...
+
** Dans le panneau de gauche, sélectionnez menu:Storage[Volumes]. Sélectionnez l’objet (base volume ou snapshot consistency group), puis cliquez sur le menu:ellipsis icon[Create instant snapshot].
** Dans le panneau de gauche, sélectionnez menu:Storage[Snapshots]. Sélectionnez l’onglet *Snapshot Images*, puis sélectionnez menu:Create[Instant snapshot Image].
+
