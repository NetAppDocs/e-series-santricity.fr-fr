...
. Sélectionnez le pool que vous souhaitez modifier, puis cliquez sur l’icône de menu : ellipsis icon[Edit Settings].
+
La fenêtre Modifier les paramètres du pool apparaît.

. Modifiez les paramètres du pool selon vos besoins.
+
.Détails du champ
[%collapsible]
====
