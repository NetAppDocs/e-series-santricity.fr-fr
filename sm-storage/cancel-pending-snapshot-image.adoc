...
. Sélectionnez le groupe d'instantanés pour lequel vous souhaitez annuler une image d'instantané en attente, puis cliquez sur menu:ellipse icon[Annuler l'image d'instantané en attente].
