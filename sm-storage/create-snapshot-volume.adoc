...
+
** Si le volume de votre snapshot est en lecture/écriture, la boîte de dialogue capacité de révision s'affiche. Accédez à  3: Reserve capacity for a snapshot volume.
** Si votre volume de snapshot est en lecture seule, la boîte de dialogue Modifier la priorité s'affiche. Accédez à  4: Edit settings for a snapshot volume.
...
Activez SSD cache
 a| 
Sélectionnez cette option pour activer la mise en cache en lecture seule sur les disques SSD. REMARQUE : cette fonctionnalité n'est pas disponible sur les systèmes de stockage EF600 ou EF300.
