...
. Sélectionnez l'hôte que vous souhaitez modifier, puis cliquez sur le menu : ellipsis icon[Edit Settings].
+
Une fenêtre s'affiche, montrant les paramètres d'hôte actuels.
